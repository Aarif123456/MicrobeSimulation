...
namespace GameBrains.Microbes.Scripts.States
{
    ...
    /// TODO: fill in any additional global state details needed.
    /// </summary>
    public class MicrobeGlobalState : State<Microbe>
    {
        private static MicrobeGlobalState instance;

        /// <summary>
        /// Prevents a default instance of the MicrobeGlobalState class from being created.
        /// </summary>
        private MicrobeGlobalState()
        {
            if (null != instance)
            {

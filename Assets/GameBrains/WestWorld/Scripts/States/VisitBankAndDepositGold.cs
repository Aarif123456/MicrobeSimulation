...
namespace GameBrains.WestWorld.Scripts.States
{
    public class VisitBankAndDepositGold : State<Miner>
    {
        ...
        /// <summary>
        /// Prevents a default instance of the VisitBankAndDepositGold class from being created.
        /// </summary>
        ...
        /// <summary>
        /// Gets the accessor for the <see cref="VisitBankAndDepositGold"/> singleton instance.
        /// </summary>
        public static VisitBankAndDepositGold Instance
        {
            get
            {
                ...
                if (null == instance)
                {
                    ...
                    return default(VisitBankAndDepositGold);
                }
        ...
        public override void Enter(Miner miner)
        {
            ...
            {
                miner.DisplayMessage("Goin' to the bank. Yes siree");
        ...
        public override void Execute(Miner miner)
        {
            ...
            miner.GoldCarried = 0;
            miner.DisplayMessage("Depositing gold. Total savings now: " + miner.MoneyInBank);

            // wealthy enough to have a well earned rest?
            if (miner.MoneyInBank >= miner.ComfortLevel)
            {
                miner.DisplayMessage("WooHoo! Rich enough for now. Back home to mah li'lle lady");
        ...
        {
            miner.DisplayMessage("Leavin' the bank");
        }

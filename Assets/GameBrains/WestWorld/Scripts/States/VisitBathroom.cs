...
namespace GameBrains.WestWorld.Scripts.States
{
    public class VisitBathroom : State<MinersWife>
    {
        ...
        /// <summary>
        /// Prevents a default instance of the VisitBathroom class from being created.
        /// </summary>
        ...
        /// <summary>
        /// Gets the accessor for the <see cref="VisitBathroom"/> singleton instance.
        /// </summary>
        ...
        {
            minersWife.DisplayMessage("Walkin' to the can. Need to powda mah pretty li'lle nose");
        }
        ...
        {
            minersWife.DisplayMessage("Ahhhhhh! Sweet relief!");
        ...
        {
            minersWife.DisplayMessage("Leavin' the Jon");
        }

...
namespace GameBrains.WestWorld.Scripts.States
{
    public class EnterMineAndDigForNugget : State<Miner>
    {
        ...
        /// <summary>
        /// Prevents a default instance of the EnterMineAndDigForNugget class from being created.
        /// </summary>
        ...
        /// <summary>
        /// Gets the accessor for the <see cref="EnterMineAndDigForNugget"/> singleton
        /// instance.
        /// </summary>
        public static EnterMineAndDigForNugget Instance
        {
            get
            {
                ...
                if (null == instance)
                {
                    ...
                    return default(EnterMineAndDigForNugget);
                }
        ...
        public override void Enter(Miner miner)
        {
            ...
            {
                miner.DisplayMessage("Walkin' to the goldmine");
        ...
        public override void Execute(Miner miner)
        {
            ...
            miner.DisplayMessage("Pickin' up a nugget");
        ...
        {
            miner.DisplayMessage("Ah'm leavin' the goldmine with mah pockets full o' sweet gold");
        }

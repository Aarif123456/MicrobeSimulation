...
namespace GameBrains.WestWorld.Scripts.States
{
    public class EatStew : State<Miner>
    {
        ...
        /// <summary>
        /// Prevents a default instance of the EatStew class from being created.
        /// </summary>
        private EatStew()
        {
            if (null != instance)
        ...
        /// <summary>
        /// Gets the accessor for the <see cref="EatStew"/> singleton instance.
        /// </summary>
        ...
        {
            miner.DisplayMessage("Smells Reaaal goood Elsa!");
        }
        ...
        {
            miner.DisplayMessage("Tastes real good too!");
        ...
        {
            miner.DisplayMessage("Thankya li'lle lady. Ah better get back to whatever ah wuz doin'");
        }

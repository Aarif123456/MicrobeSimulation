...
namespace GameBrains.WestWorld.Scripts.States
{
    public class QuenchThirst : State<Miner>
    {
        ...
        /// <summary>
        /// Prevents a default instance of the QuenchThirst class from being created.
        /// </summary>
        ...
        /// <summary>
        /// Gets the accessor for the <see cref="QuenchThirst"/> singleton instance.
        /// </summary>
        ...
        public override void Enter(Miner miner)
        {
            ...
            {
                miner.DisplayMessage("Boy, ah sure is thusty! Walking to the saloon");
        ...
        public override void Execute(Miner miner)
        {
            ...
            miner.DisplayMessage("That's mighty fine sippin' liquer");
        ...
        {
            miner.DisplayMessage("Leaving the saloon, feelin' good");
        }

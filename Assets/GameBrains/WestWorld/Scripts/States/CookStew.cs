...
namespace GameBrains.WestWorld.Scripts.States
{
    public class CookStew : State<MinersWife>
    {
        ...
        /// <summary>
        /// Prevents a default instance of the CookStew class from being created.
        /// </summary>
        private CookStew()
        {
            if (null != instance)
        ...
        /// <summary>
        /// Gets the accessor for the <see cref="CookStew"/> singleton instance.
        /// </summary>
        ...
        public override void Enter(MinersWife minersWife)
        {
            ...
            {
                minersWife.DisplayMessage("Putting the stew in the oven.");
                ...
                MessageDispatcher.Instance.DispatchMsg(
                    ...
                    (MessageTypes)WestWorldMessageTypes.StewReady, // msg
        ...
        {
            minersWife.DisplayMessage("Fussin' over food");
        }
        ...
        {
            minersWife.DisplayMessage("Puttin' the stew on the table");
        }
        ...
        public override bool OnMessage(MinersWife minersWife, Telegram msg)
        {
            switch ((WestWorldMessageTypes)msg.Msg)
            {
                case WestWorldMessageTypes.StewReady:
                    {
                        //Debug.Log("Message received by " + minersWife.name + " at time: " + Time.time);
                        minersWife.DisplayMessage("StewReady! Lets eat");

                        // let hubby know the stew is ready
                        MessageDispatcher.Instance.DispatchMsg(
                            MessageDispatcher.SendMsgImmediately,
                            minersWife.ID,
                            EntityManager.Find<Miner>("Bob").ID,
                            (MessageTypes)WestWorldMessageTypes.StewReady,
                            MessageDispatcher.NoAdditionalInfo);

                        minersWife.IsCooking = false;

...
namespace GameBrains.WestWorld.Scripts.States
{
    public class WifesGlobalState : State<MinersWife>
    {
        ...
        /// <summary>
        /// Prevents a default instance of the WifesGlobalState class from being created.
        /// </summary>
        ...
        /// <summary>
        /// Gets the accessor for the <see cref="WifesGlobalState"/> singleton instance.
        /// </summary>
        public static WifesGlobalState Instance
        {
            get
            {
                ...
                if (null == instance)
                {
                    ...
                    return default(WifesGlobalState);
                }
        ...
        public override bool OnMessage(MinersWife minersWife, Telegram msg)
        {
            ...
            {
                case WestWorldMessageTypes.HiHoneyImHome:
                    {
                        //Debug.Log("Message handled by " + minersWife.name + " at time: " + Time.time);

                        minersWife.DisplayMessage("Hi honey. Let me make you some of mah fine country stew");

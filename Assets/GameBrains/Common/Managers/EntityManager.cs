...
namespace GameBrains.Common.Managers
{
    public static class EntityManager
    {
        static readonly Dictionary<uint, Entity> EntityIdDictionary = new Dictionary<uint, Entity>();
        static readonly Dictionary<string, Entity> EntityNameDictionary = new Dictionary<string, Entity>();
        ...
        public static T Find<T>(uint entityId) where T : Entity
        {
        ...
        public static List<T> FindAll<T>() where T : Entity
        {
            ...
            foreach (var entity in EntityIdDictionary.Values)
            {

...
namespace GameBrains.Common.Timers
{
    /// <summary>
    ...
    public class SimpleRegulator
    {
        ...
        /// </summary>
        public SimpleRegulator()
        {
            nextUpdateTime = Time.time * 1000 + Random.Range(0, 1000);
            UpdatePeriod = 10;
        }
        ...
        /// </param>
        public SimpleRegulator(float updatesPerSecond)
            : this()
        {
        ...
        /// </param>
        public SimpleRegulator(float updatesPerSecond, long updatePeriodVariator)
